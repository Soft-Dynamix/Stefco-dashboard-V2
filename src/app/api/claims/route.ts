  ...
  try {
    ...
    const claim = await db.claim.create({
      data: {
        ...
        vehicleVinNumber: body.vehicleVinNumber,
    ...
    if (body.sourceText && body.insuranceCompanyId) {
      ...
      const fieldsToLearn: Array<{ field: string; value: string | null }> = [
        ...
        { field: "vehicleVinNumber", value: body.vehicleVinNumber },
        { field: "vehicleMake", value: body.vehicleMake },
        { field: "vehicleModel", value: body.vehicleModel },
        { field: "vehicleYear", value: body.vehicleYear ? String(body.vehicleYear) : null },
        { field: "vehicleColor", value: body.vehicleColor },
        { field: "engineNumber", value: body.engineNumber },
